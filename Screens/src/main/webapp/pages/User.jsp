    ...
    <link rel="apple-touch-icon" sizes="76x76" href="../assets/img/apple-icon.png">
      <link rel="icon" type="image/png" href="../assets/img/favicon.png">
        ...
        function saveUserProfile(){
          ...
          $.ajax({
            type: 'POST',
            //url: servletURL + 'UserProfileServlet',
            url: "/UserProfile",
        ...
        $(document).ready(function() {
          ...
          if(secID == "${secQuestion.securityQuestionId}"){
        	  var str  = "${secQuestion.securityQuestion}";
            document.getElementById('securityQuestionOption').textContent=str.replace("'", "\'");;
          }
          </c:forEach>
          ...
          var str  = "${securityQuestion.securityQuestion}";
          option.textContent = str.replace("'", "\'");
