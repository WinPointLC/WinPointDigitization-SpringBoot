          ...
          <a class="nav-link" href="#" onclick="User_link();">
            ...
            <p>User Profile</p>
				...
				<li id="main-course">
					...
					<a class="nav-link" href="#" onclick="MainCourse_link();"> <i
				...
				<li id="analytics-link">
					...
					<a class="nav-link" href="#" onclick="Analytics_link();"> <i
				...
				<li id="res-link">
					...
					<a class="nav-link"> <i class="material-icons">subject</i>
						<p>Result</p>
				</a>
				</li>
				...
				<div class="card card-signup card-plain">
					...
					<div class="modal-body">
						<p>
							...
							degree of concurrence with each of these statements on a scale of
							(1) to (5), where<br> (1)Strongly Disagree, (2) Disagree,
							(3)Cant say/Neutral, (4)Agree, (5)Strongly Agree
						</p>
						<!--   <form  name="myForm"  id="" >-->
