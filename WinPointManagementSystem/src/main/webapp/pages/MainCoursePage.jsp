...
<body>
									...
									<div class="col-lg-3 col-md-6 col-sm-6 column1">
										<div class="card card-stats">
											<div class="card-header card-header-icon">
												...
												<a href="TestSelectPage"><p class="card-category">English
														Language Skills</p></a>
											</div>
									...
									<div class="col-lg-3 col-md-6 col-sm-6 column2">
										<div class="card card-stats">
											<div class="card-header card-header-icon">
												...
												<a href="TestSelectPage"><p class="card-category">Oral
														Communication</p></a>
											</div>
									...
									<div class="col-lg-3 col-md-6 col-sm-6 column1">
										<div class="card card-stats">
											<div class="card-header card-header-icon">
												...
												<a href="TestSelectPage"><p class="card-category">Quantitative
														Aptitude</p></a>
											</div>
									...
									<div class="col-lg-3 col-md-6 col-sm-6 column2">
										<div class="card card-stats">
											<div class="card-header card-header-info card-header-icon">
												...
												<a href="TestSelectPage"><p class="card-category">Logical
														Reasoning</p></a>
											</div>
									...
									<div class="col-lg-3 col-md-6 col-sm-6 column3">
										<div class="card card-stats">
											<div class="card-header card-header-icon">
												...
												<a href="TestSelectPage"><p class="card-category">Verbal
														Reasoning</p></a>
											</div>
										</div>
									</div>
						...
						success : function(jsonObj) {
							...
							for (i = 0; i < (responseJson.length); i = i + 3) {
								...
								for (j = i; j < i + 3
									...
									cardicon.className = 'card-icon';
									var image = document.createElement('img');
									image.setAttribute('src',responseJson[j].logoLocation);
									image.setAttribute('style'," height: 60px; width: 60px; ");
									image.setAttribute('alt', "java");
									cardicon.appendChild(image);
									cardheader.appendChild(cardicon);
	...
	<script>
		...
		//alert(document.getElementById('courses');
