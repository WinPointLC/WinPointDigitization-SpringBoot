...
<body>
	...
	<div class="card card-nav-tabs">
		...
		<form:form method="post" action="saveForm" id="enqForm"
					...
					<div class="form-row">
						<div class="col">
							...
							<form:input type="text" class="form-control" path="MobileNo"
								id="mobNo" placeholder="Mobile Number" required="true" />
						</div>
					</div>
					<div class="form-row">
						<div class="col">
							...
							<form:input type="email" class="form-control" path="emailId"
								id="email" placeholder="Email Id" required="true" />
						</div>
					</div>
						...
						<div class="col">
							<div class="form-group">
								...
								<form:input type="text" path="birthDateString"
									placeholder="yyyy-mm-dd" class="form-control" required="true"
									id="bdayId" />
							</div>
						</div>
					</div>
						...
						<div class="col">
							...
							<div class="form-check form-check-radio">
								<label class="form-check-label"> <form:radiobutton
										...
										checked="true" /> Male <span class="circle"> <span
										class="check"></span>
								</span>
								</label>
							</div>
							<div class="form-check form-check-radio">
								<label class="form-check-label"> <form:radiobutton
									...
									Female <span class="circle"> <span class="check"></span>
								</span>
								</label>
							</div>
				...
				<div class="card-body">
					<div class="form-row">
						<div class="col">
							...
							<form:input type="text" class="form-control inputFileVisible"
								path="college" id="college" required="true"
					...
					<div class="form-row">
						...
						<div class="col">
							...
							<form:select class="form-control selectpicker" path="degree"
					...
					<div class="form-row">
						<div class="col">
							...
							<form:input type="text" class="form-control inputFileVisible"
								required="true" id="branch" path="branch"
			...
			<div class="card card-nav-tabs">
				<h4 class="card-header card-header-primary">Professional and
				...
				<div class="card-body">
					<div class="form-row">
						<div class="col">
							...
							<form:input type="text" class="form-control inputFileVisible"
								path="occupation" placeholder="Enter Occupation" />
						</div>
					</div>
					<div class="form-row">
						<div class="col">
							...
							<form:input type="text" class="form-control inputFileVisible"
								path="designation" placeholder="Enter Designation" />
						</div>
					</div>
					<div class="form-row">
						<div class="col">
							...
							<form:input type="text" class="form-control inputFileVisible"
								path="domain" placeholder="Enter Domain" />
						</div>
					</div>
					<div class="form-row">
						<div class="col">
							...
							<form:input type="text" class="form-control inputFileVisible"
								required="true" id="yearOfGraduation" path="yearOfGraduation"
					...
					<div class="form-row">
						<div class="col">
							...
							<form:input type="text" class="form-control inputFileVisible"
								path="role" placeholder="Enter Role" />
						</div>
					</div>
					...
					<div class="form-row">
						<div class="col">
							...
							<form:input type="text" class="form-control inputFileVisible"
								...
								placeholder="Experience (in months)" required="true" />
						</div>
					</div>
				...
				<div class="card-body">
					...
					<div class="form-row">
						<div class="col">
							...
							<form:select class="form-control selectpicker"
								path="mappingCourseInterestedIn" id="course_interested"
								multiple="true">
					...
					<div class="form-row">
						<div class="col">
							...
							<div class="form-check form-check-radio">
								<label class="form-check-label"> <form:radiobutton
										class="form-check-input" path="eligibility" value="Eligible"
										checked="true" /> Eligible <span class="circle"> <span
										class="check"></span>
								</span>
								</label>
							</div>
					...
					<div class="form-row">
						<div class="col">
							...
							<form:select class="form-control selectpicker"
								path="mappingCoursesAlreadyDone" multiple="true">
				 ...
				 <div class="form-row">
					...
					<div class="form-row">
						<div class="col">
							...
							<label for="avail_time">Available Time</label>
							<form:select name="availableTime"
								class="form-control selectpicker" path="mappingTimeSlots"
								id="avail_time" required="true">
								<c:forEach items="${availableTimeList}" var="availableTime">
									<option name="availableTime"
										value="${availableTime.timeSlotsId}">${availableTime.timeSlotsDescription}</option>
								</c:forEach>
							</form:select>
					...
					<div class="form-row">
						<div class="col">
							...
							<form:input type="text" class="form-control inputFileVisible"
								path="reference" placeholder="Reference" />
						</div>
					</div>
					...
					<div class="form-row">
						<div class="col">
							<div class="form-group">
								...
								<form:input type="text" path="dateOfEnquiryString"
									placeholder="yyyy-mm-dd" id="date_enquiry" required="true"
									class="form-control" />
							</div>
						</div>
					</div>
					...
					<div class="form-row">
						<div class="col">
							...
							<form:input type="text" class="form-control inputFileVisible"
								path="recommendation" placeholder="Recommendation" />
						</div>
					</div>
					...
					<div class="form-row">
						<div class="col">
							<div class="form-group">
								...
								<form:input type="text" path="startDateString"
									placeholder="yyyy-mm-dd" id="date_start" required="true"
									class="form-control" />
							</div>
						</div>
					</div>
					...
					<div class="form-row">
						<div class="col">
							<label for="segment_type">Segment Type</label>
							<form:select name="segmentType" class="form-control selectpicker"
								id="seg_type" path="mappingSegmentType" required="true">
								<c:forEach items="${segmentTypeList}" var="segmentType">
									<option name="segmentType" value="${segmentType.segmentTypeId}">${segmentType.segmentTypeName}</option>
								</c:forEach>
							</form:select>
					...
					<div class="form-row">
						<div class="col">
							...
							<form:input type="text" class="form-control inputFileVisible"
								path="suggestion" placeholder="Suggestions" />
						</div>
					</div>
					...
					<div class="form-row">
						<div class="col">
							...
							<div class="form-check form-check-radio">
								<label class="form-check-label"> <form:radiobutton
										class="form-check-input" path="activeStatus" value="1"
										checked="true" /> Active <span class="circle"> <span
										class="check"></span>
								</span>
								</label>
							</div>
			...
			<input type="button" class="btn btn-primary"
				style="margin-left: 40%; width: 15%;" value="Submit"
				onclick="submitForm()" />
	...
	<script type="text/javascript">
		...
		function validation() {
			...
			var courses_interested = document
					.getElementById('course_interested').value;
