...
<html lang="en">
	...
	<body>
		...
		<div class="Include-jsp" id="iframediv">
			<iframe src="FeeRegistrationPage-New.jsp" width="1000" height="700" id="Fee-jsp"></iframe>
			...
			<iframe src="Entities.jsp" width="1000" height="700" id="Entities-jsp"></iframe>
